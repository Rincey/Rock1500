...
#[array]$Wordlist = $js.Split(',') -replace """"
...
<#
    [string[]]$KnownLetters = "r"
    [string[]]$ExcludedLetters = "stae"
    [validateLength(5, 5)]
    [string]$Positions = "***r*"
    [int]$MaximumResults = 101
#>
...
# sorting on last characters:
#$PossibleSolutions | Sort-Object {$_[-1]}